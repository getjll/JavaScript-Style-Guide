...
## 命名
  ...
  - **拓展名**: 使用`.jsx`作为React组件文件的拓展名。 eslint: [`react/jsx-filename-extension`](https://github.com/yannickcr/eslint-plugin-react/blob/master/docs/rules/jsx-filename-extension.md)
